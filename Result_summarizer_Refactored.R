...
analyze_auc_single(
  input_dir = "/mnt/d/Labs/Pharmaco-Omics/stabl/results_prognosis_Biosignature_ICGC",
  models    = c("LOGIT", "RF", "PLSDA", "SVM"),
  out_dir   = "/mnt/d/Labs/Pharmaco-Omics/stabl/results_prognosis_Biosignature_ICGC_SUMMARY"
)